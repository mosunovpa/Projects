...
uses
	Forms, Controls, Registry, TypInfo, Classes, dbgrids;
...
type
  ...
  public
    ...
    procedure StoreDBGridState(grid: TDBGrid);
    procedure LoadDBGridState(grid: TDBGrid);
  protected
...
begin
	FStorage := TRegIniFile.Create('Software\Apteka');
end;
...
procedure TStorage.StoreDBGridState(grid: TDBGrid);
var
	i: integer;
begin
	try
        ...
        begin
			WriteInteger(grid.Name + '_Column_' + IntToStr(i) + '_Width', grid.Columns[i].Width);
        end;
    except
    end;
end;

procedure TStorage.LoadDBGridState(grid: TDBGrid);
var
	i: integer;
begin
	try
        ...
        begin
			grid.Columns[i].Width :=
            	ReadInteger(grid.Name + '_Column_' + IntToStr(i) + '_Width', 50);
        end;
    except
    end;
end;
