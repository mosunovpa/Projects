...
class CScintillaT : public TBase, 
	public CScintillaIF<CScintillaT<TBase> >
{
...
class CScintillaWindowImpl : public CWindowImplBaseT<CScintillaT<TBase>, TWinTraits>
{
	...
	HWND Create(HWND hWndParent, ATL::_U_RECT rcPos, LPCTSTR szWindowName = NULL,
			DWORD dwStyle = 0, DWORD dwExStyle = 0,
			ATL::_U_MENUorID nID = 0, LPVOID lpCreateParam = NULL)
	{
