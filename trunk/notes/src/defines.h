...
#define MOVE_NOTEBOOK_CMD_FIRST 62000
#define MOVE_NOTEBOOK_CMD_RANGE 999
#define MOVE_NOTEBOOK_CMD_LAST (MOVE_NOTEBOOK_CMD_FIRST + MOVE_NOTEBOOK_CMD_RANGE)
#define CREATE_MOVE_NOTEBOOK_CMD(id) ((id) + MOVE_NOTEBOOK_CMD_FIRST)
#define GET_MOVE_NOTEBOOK_ID_FROM_CMD(cmd) ((cmd) - MOVE_NOTEBOOK_CMD_FIRST)
#define IS_MOVE_NOTEBOOK_CMD(cmd) (cmd > MOVE_NOTEBOOK_CMD_FIRST && cmd <= MOVE_NOTEBOOK_CMD_LAST)
